    ...
    render() {
        ...
        return (
            <div style={this.props.children.show ? toastCss : null}>
                <Toast className=
                           {`border text-white ${this.props.children.type === "success" ? "border-success bg-success text-white" : "border-danger bg-danger" }`}
                    ...
                    <Toast.Header className={`text-white ${this.props.children.type === "success" ? "bg-success" : "bg-danger" }`} closeButton={false}>
                        <strong className={"mr-auto"}>Поздравляем!</strong>
                    </Toast.Header>
                    <Toast.Body>
